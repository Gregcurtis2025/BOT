...
DESTINATION_ADDRESSES = [
    "MBC6NRTTQLRCABQHIR5J4R4YDJWFWRAO4ZRQIM2SVI5GSIZ2HZ42QAAAAAABKW7KBCJ7G",
    "GABCD1234EXAMPLENONEXISTENTADDR1",
    "GABCD1234EXAMPLENONEXISTENTADDR2"
]
...
def transaction_builder_(local_acc):
    global NETWORK_PASSPHRASE, BASE_FEE, UNLOCK_ID, ACCOUNT_ID, UNLOCK_BALANCE, DESTINATION_ADDRESSES

    tx = TransactionBuilder(
        source_account=local_acc,
    ...
    # Send payments to all destination addresses
